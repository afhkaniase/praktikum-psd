...
$$
\hat{Y_t}=-1.6865257+0.2155973X_1+0.0293849X_2+2.8998954X_3+1.9223654X_4+0.1716632X_5-0.7237225X_6
$$

Koefisien X1 (PDB per kapita) adalah 0.2155973, yang berarti bahwa ketika variabel X1 (PDB per kapita) naik satu satuan, maka perkiraan nilai variabel dependen Y (Skor Kebahagiaan) akan meningkat sebesar 0.2155973, dengan asumsi variabel lainnya tetap konstan.

Koefisien X2 (Harapan hidup sehat) adalah 0.0293849, yang berarti bahwa ketika variabel X2 (Harapan hidup sehat) naik satu satuan, maka perkiraan nilai variabel dependen Y (Skor Kebahagiaan) akan meningkat sebesar 0.0293849, dengan asumsi variabel lainnya tetap konstan.

Koefisien X3 (Dukungan Sosial) adalah 2.8998954, yang berarti bahwa ketika variabel X3 (Dukungan Sosial) naik satu satuan, maka perkiraan nilai variabel dependen Y (Skor Kebahagiaan) akan meningkat sebesar 2.8998954, dengan asumsi variabel lainnya tetap konstan.

Koefisien X4 (Kekebasan dalam menentukan pilihan hidup) adalah 1.9223654, yang berarti bahwa ketika variabel X4 (Kekebasan dalam menentukan pilihan hidup) naik satu satuan, maka perkiraan nilai variabel dependen Y (Skor Kebahagiaan) akan meningkat sebesar 1.9223654, dengan asumsi variabel lainnya tetap konstan.

Koefisien X5 (Kemurahan hati) adalah 0.1716632, yang berarti bahwa ketika variabel X5 (Kemurahan hati) naik satu satuan, maka perkiraan nilai variabel dependen Y (Skor Kebahagiaan) akan meningkat sebesar 0.1716632, dengan asumsi variabel lainnya tetap konstan.

Koefisien X6 (Persepsi korupsi) adalah -0.7237225, yang berarti bahwa ketika variabel X6 (Persepsi korupsi) naik satu satuan, maka perkiraan nilai variabel dependen Y (Skor Kebahagiaan) akan menurun sebesar -0.7237225, dengan asumsi variabel lainnya tetap konstan.
